...
export const fetchPets = createAsyncThunk("pets/fetchPets", async () => {
  const response = await fetch("http://ancient-sands-09925.herokuapp.com/pets", {
    method: "GET",
    credentials: "include"
  });
...
export const deletePet = createAsyncThunk("http://ancient-sands-09925.herokuapp.com/pets/deletePet", async (id) => {
...
export const updatePet = createAsyncThunk("pets/updatePet", async (pet) => {
  const response = await fetch(`http://ancient-sands-09925.herokuapp.com/pets/${pet.id}`, {
    method: "PATCH",
